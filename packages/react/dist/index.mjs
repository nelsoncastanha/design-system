...
function createSlot(ownerName) {
  ...
  const Slot2 = React8.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx4(SlotClone, __spreadProps(__spreadValues({}, slotProps), { ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null }));
    }
    return /* @__PURE__ */ jsx4(SlotClone, __spreadProps(__spreadValues({}, slotProps), { ref: forwardedRef, children }));
  });
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node = React9.forwardRef((props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx5(Comp, __spreadProps(__spreadValues({}, primitiveProps), { ref: forwardedRef }));
  });
...
function Checkbox2(props) {
  return /* @__PURE__ */ jsx7(CheckboxContainer, __spreadProps(__spreadValues({}, props), { children: /* @__PURE__ */ jsx7(CheckboxIndicator2, { asChild: true, children: /* @__PURE__ */ jsx7(Check, { weight: "bold" }) }) }));
}
